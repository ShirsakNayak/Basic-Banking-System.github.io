...
<br>
	...
	<div>
		<h1 style="font-family:serif;text-align:center;color: black;">User's Account Details</h1>
		<table style="background-color:rgb(210,100,0);">
           <th>CUSTOMER ID</th>
           <th>NAME </th>
           <th>EMAIL</th>
...
<br><br>
	<h3 style="font-family: serif;color: wheat;">Select the user from the dropdown list</h3>
	<table border="0px" style="background-color:#orange;">
		<tr>
		<td>Transfer To:</td>
		<td><select name="user">
